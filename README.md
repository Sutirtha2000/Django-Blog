# Django Blog Project — Premium Course (Sutirtha Nath)

**Welcome!**  
This repository contains the source code for the *Django Blogging System* premium course by **Sutirtha Nath**. This is a real-world, feature-rich blogging system built to teach practical Django — from models, templates and forms to permissions, dashboards and deployment.
...
- (Optional) nginx / gunicorn for production — [contact me]
All the best.